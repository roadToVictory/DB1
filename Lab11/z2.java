...
if (c != null) {
    ...
    try { 
      ...
      //  Wykorzystane elementy: setString, executeQuery
       PreparedStatement pst = c.prepareStatement("SELECT imie, nazwisko, opis FROM lab04.uczestnik ucz JOIN lab04.uczest_kurs uk ON ucz.id_uczestnik=uk.id_uczest JOIN lab04.kurs ku using(id_kurs) JOIN lab04.kurs_opis ko ON ku.id_nazwa=ko.id_kurs WHERE nazwisko LIKE ?", ResultSet.TYPE_SCROLL_SENSITIVE,ResultSet.CONCUR_UPDATABLE);
       pst.setString(1,"S%");
       ResultSet rs ;
       rs = pst.executeQuery();
       while (rs.next())  {
