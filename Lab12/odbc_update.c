...
int odbc_update()
{
	...
	strcpy(wszInput, "UPDATE lab04.person set fname=?, lname=? where person_id=?;");
	...
	RetCode = SQLBindParameter(hStmt, 3, SQL_PARAM_INPUT, SQL_C_LONG, SQL_INTEGER, 0, 0, person_id, 0, NULL);
	
	RetCode = SQLBindParameter(hStmt, 1, SQL_PARAM_INPUT, SQL_C_CHAR, SQL_CHAR, IMIE_L, 0, imie, IMIE_L, &imie_l);
	
	RetCode = SQLBindParameter(hStmt, 2, SQL_PARAM_INPUT, SQL_C_CHAR, SQL_CHAR, NAZWISKO_L, 0, nazwisko, NAZWISKO_L, &nazwisko_l);
